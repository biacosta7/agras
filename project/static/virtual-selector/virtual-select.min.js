              ...
              if (this.$ele) {
                ...
                this.additionalClasses &&
                  ...
                  this.additionalToggleButtonClasses &&
                    (i += " ".concat(this.additionalToggleButtonClasses)),
                  this.multiple &&
                    ((t += " multiple"),
            ...
            value: function (e) {
              ...
              if (i) {
                ...
                return (
                  ...
                  (r.innerHTML = n),
                  i.appendChild(r),
                  p.addClass(r, "vscomp-dropbox-wrapper ".concat(t)),
                  ""
                );
              }
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (
                ...
                return (
                  e.preventDefault(),
                  void (this.keepAlwaysOpen
                    ? this.$dropboxContainerTop.focus()
                    : (this.closeDropbox(), this.$wrapper.focus()))
                );
              if (document.activeElement === this.$searchInput && 9 === t)
                return e.preventDefault(), void this.focusFirstVisibleOption();
              if (27 === t || "Escape" === e.key) {
                ...
                if (
                  ...
                  return this.closeDropbox(), void this.$wrapper.focus();
              }
              i && this[i](e);
            },
          },
              ...
              this.disabledOptions.forEach(function (e) {
                ...
                Array.isArray(t) &&
                  t.forEach(function t(O) {
                    ...
                    if (
                      (g || "" !== x || (g = !0),
                      o && (E.isDisabled = !0 === m[x]),
                      O.isGroupOption &&
                        ((E.isGroupOption = !0), (E.groupIndex = O.groupIndex)),
                      u && (E.description = h(c(O[a]))),
                      O.customData && (E.customData = O.customData),
                      i.push(E),
                      (y += 1),
                      C)
                    ) {
            ...
            value: function () {
              var e = this,
                ...
                d =
                  ...
                  !n;
              if (d && this.hideValueTooltipOnSelectAll)
                r.innerHTML = ""
                ...
                this.getSelectedOptions({
                  ...
                  if (
                    ...
                    var c = s.willTextOverflow(r.parentElement, i)
              ...
              var g = "";
              0 === c ? (g = this.placeholder) : n || (g = u.join(", ")),
                n || p.setData(r, "tooltip", g),
                t &&
                  (n
                    ? this.updatePosition()
                    : p.setData(r, "tooltipEllipsisOnly", 0 === c));
            },
          },
          {
            key: "setSearchValue",
