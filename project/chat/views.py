    ...
    if request.method == "POST":
        try:
            ...
            prompt = (
                ...
                f"Regra 4: Não mencione a inexistência de cultivos selecionados, nem as informações que você não possui, tente me ajudar com as informacoes que eu te passei.\n"
                f"Regra 5: Para eu selecionar cultivos, devo clicar em 'Utilizades' localizado acima."
                f"Regra 6: Na primeira interação, apenas se não for uma saudação, não faça grandes textos. Se eu só te der uma saldação, seja breve e educado, perguntando o que desejo e como você pode me ajudar.\n"
